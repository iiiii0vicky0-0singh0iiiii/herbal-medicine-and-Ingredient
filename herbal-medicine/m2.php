...
function displayMedicineInformation($result) {
    ...
    // Display openfda information
   // if (isset($result['openfda'])) {
      //  echo '<strong>Brand Name:</strong> ' . implode(", ", $result['openfda']['brand_name'] ?? [1]) . '<br>';
       // echo '<strong>Generic Name:</strong> ' . implode(", ", $result['openfda']['generic_name'] ?? [1]) . '<br>';
       // echo '<strong>Manufacturer Name:</strong> ' . implode(", ", $result['openfda']['manufacturer_name'] ?? [1]) . '<br>';
    }
    ...
    //     if ($field === 'storage_and_handling' || $field === 'do_not_use') {
    //         // Handle special formatting for 'storage_and_handling' and 'do_not_use' fields
