...
<body>
    ...
    if (!empty($searchResults['results'])) {
        ...
        foreach ($searchResults['results'] as $result) {
            echo '<strong>Drug Name:</strong> ' . ($result['openfda']['generic_name'][0] ?? 'N/A') . '<br>';
            
            // Check if 'manufacturer_name' key exists before trying to access it
            echo '<strong>Manufacturer:</strong> ' . (isset($result['openfda']['manufacturer_name'][0]) ? $result['openfda']['manufacturer_name'][0] : 'N/A') . '<br>';
